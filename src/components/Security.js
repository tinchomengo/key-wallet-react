  ...
  return (
    <div className="custom-prev-arrow">
      <div
        ...
        onClick={onClick}
      >
        <img src="static/images/Security/arrow-left.png" alt="Previous" />
      </div>
    </div>
  );
};
          ...
          <div className="carousel-container">
            <Slider {...settings}>
              <div className="slide-content">
                ...
                <p>
                  Key Wallet utilizes state-of-the-art encryption technologies
                  to protect all data transmissions between devices and servers.
                  This includes employing secure sockets layer (SSL) and
                  transport layer security (TLS) protocols, ensuring that all
                  sensitive information is kept private and secure from
                  interception.
                </p>{" "}
              </div>
              <div className="slide-content">
                ...
                <p>
                  To maintain the highest security standards, Key Wallet
                  undergoes frequent audits conducted by leading independent
                  security firms. These comprehensive reviews ensure that all
                  aspects of our security measures are up-to-date and effective
              ...
              <div className="slide-content">
                ...
                <p>
                  Users can enhance their security settings by enabling
                  biometric authentication methods such as fingerprint scanning
                  or facial recognition. This feature adds a personal layer of
                  security, making it nearly impossible for unauthorized users
              ...
              <div className="slide-content">
                ...
                <p>
                  ...
                  financial regulations, including anti-money laundering (AML)
                  and know-your-customer (KYC) practices, reinforces our
                  commitment to security and transparency.
                </p>
                <h4>Certified Security Practices</h4>
                <p>
                  Our security protocols are certified by recognized global
                  standards, ensuring that Key Wallet meets rigorous
                  international security specifications and best practices.
                </p>
              </div>
              <div className="slide-content">
                <img
                ...
                <p>
                  ...
                  protect their accounts. Our platform provides detailed
                  security tips, guides on recognizing phishing attempts, and
                  best practices for digital asset management to enhance user
              ...
              <div className="slide-content">
                ...
                <p>
                  Key Wallet is dedicated to providing a secure environment
                  where you can confidently manage your digital assets. With
            ...
            <Carousel
              ...
              renderArrowNext={(onClickHandler, hasNext, label) =>
                hasNext && (
                  ...
                  >
                    <img
                      src="static/images/Security/arrow-right.png"
                      alt="Next"
                    />
                  </button>
                )
            ...
            >
              <div className="carousel-slide">
                ...
                <div className="carousel-caption-double">
                  ...
                  <p>
                    Key Wallet utilizes state-of-the-art encryption technologies
                    to protect all data transmissions between devices and
                    servers. This includes employing secure sockets layer (SSL)
                    and transport layer security (TLS) protocols, ensuring that
                    all sensitive information is kept private and secure from
                    interception.
                  </p>
                </div>
              </div>
              <div className="carousel-slide">
                ...
                <div className="carousel-caption-double">
                  ...
                  <p>
                    ...
                    undergoes frequent audits conducted by leading independent
                    security firms. These comprehensive reviews ensure that all
                    aspects of our security measures are up-to-date and
                    effective against the latest cybersecurity threats.
                  </p>
                </div>
              </div>
              <div className="carousel-slide">
              ...
              <div className="carousel-slide">
                ...
                <div className="carousel-caption-double">
                  ...
                  <p>
                    ...
                    scanning or facial recognition. This feature adds a personal
                    layer of security, making it nearly impossible for
              ...
              <div className="carousel-slide">
                ...
                <div className="carousel-caption-double-2">
                  ...
                  <h4>Regulatory Compliance</h4>
                  <p>
                    Key Wallet adheres to strict regulatory standards designed
                    to protect users and their assets. Compliance with
                    international financial regulations, including anti-money
                    laundering (AML) and know-your-customer (KYC) practices,
                    reinforces our commitment to security and transparency.
                  </p>
                  <h4>Certified Security Practices</h4>
                  <p>
                    Our security protocols are certified by recognized global
              ...
              <div className="carousel-slide">
                ...
                <div className="carousel-caption-double">
                  ...
                  <h4>Proactive User Guidance</h4>
                  <p>
                    Key Wallet believes in empowering users with the knowledge
                    to protect their accounts. Our platform provides detailed
                    security tips, guides on recognizing phishing attempts, and
                    best practices for digital asset management to enhance user
                    awareness and safety.
                  </p>
